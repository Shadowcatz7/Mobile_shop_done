                    ...
                    <form class="form-horizontal" action="" enctype="multipart/form-data" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="title" name="title" value="<?php echo $post->tieu_de ?>" required placeholder="Tiêu đề">
                                    <input type="hidden" name="id" value="<?php echo isset($_GET['ma_bv']) ? $_GET['ma_bv'] : 0; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div style="height:300px;width:100%" id="editor"><?php echo $post->noi_dung ?></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="select2 form-control custom-select" name="status" style="width: 100%; height:36px;">
                                        <option value="0" <?php echo ($post->trang_thai == 0) ? 'selected' : '' ?>>Lưu nháp</option>
                                        <option value="1" <?php echo ($post->trang_thai == 1) ? 'selected' : '' ?>>Hoạt động</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="border-top">
                            <div class="card-body">
                                <button type="submit" name="btn-submit" id="subformpost" class="btn btn-primary">Lưu</button>
                            </div>
                        </div>
                    </form>
                </div>
